          ...
          {data
            ...
            : [0, 1, 2, 3, 4].map((e) => (
                <div key={e} className="flex items-center justify-center gap-2 py-2">
                  <div className="w-16 h-16 bg-gray-300 dark:bg-gray-600 skeleton-box" />
                  <div className="flex flex-col flex-1 space-y-1">
                    <div
                      className="h-4 bg-gray-300 dark:bg-gray-600 skeleton-box"
                  ...
                  <div className="w-8 h-5 bg-gray-300 dark:bg-gray-600 skeleton-box" />
                </div>
              ))}
        </div>
        {data && (
